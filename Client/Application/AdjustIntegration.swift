...
class AdjustIntegration: NSObject {
    ...
    fileprivate func saveAttribution(_ attribution: ADJAttribution) throws -> Void {
        ...
        dictionary["_timestamp"] = NSNumber(longLong: Int64(Date().timeIntervalSince1970))
        let data = try JSONSerialization.dataWithJSONObject(dictionary, options: [JSONSerialization.WritingOptions.PrettyPrinted])
