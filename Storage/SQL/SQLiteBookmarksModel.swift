...
open class SQLiteBookmarksModelFactory: BookmarksModelFactory {
    ...
    open func isBookmarked(_ url: String) -> Deferred<Maybe<Bool>> {
        ...
        " LIMIT 1)"
        let args: Args = [url as AnyObject, url as AnyObject]
    ...
    func hasDesktopBookmarks() -> Deferred<Maybe<Bool>> {
        ...
        let parents: Args = [
            // Local.
            BookmarkRoots.MenuFolderGUID as AnyObject,
            BookmarkRoots.ToolbarFolderGUID as AnyObject,
            BookmarkRoots.UnfiledFolderGUID as AnyObject,
...
extension SQLiteBookmarks: SearchableBookmarks {
    public func bookmarksByURL(_ url: NSURL) -> Deferred<Maybe<Cursor<BookmarkItem>>> {
        ...
        let args: Args = [u as AnyObject, u as AnyObject]
...
open class MergedSQLiteBookmarks: BookmarksModelFactorySource {
    ...
    open let buffer: SQLiteBookmarkBufferStorage_Brave
